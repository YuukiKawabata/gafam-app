...
export default function Answer() {
  ...
  const lists = [
    ...
    {
      name: "ジェフ\nベゾス",
      value: "会社には2種類ある。高く売るために努力する会社と、安く売るために努力する会社だ。我々は後者になる。",
    },
    {
      name: "ジェフ\nベゾス",
      value: "顧客のニーズから逆算せよ。",
    ...
    {
      name: "ジェフ\nベゾス",
      value: "アマゾンの企業文化は「調和」と「情熱」だが、いざどちらかを選ぶとなれば、我々は「情熱」をとる。",
    },
    {
      name: "ジェフ\nベゾス",
    ...
    {
      name: "ジェフ\nベゾス",
      value: "自分のもっている時間を100%とすると、かつては30%をサービスの構築に、残りの70％をプレゼンに充てたが、時代は変わった。これからは逆だ。",
    },
    {
      name: "ジェフ\nベゾス",
    ...
    {
      name: "ビル\nゲイツ",
      value: "私は物事をとことん突き詰めるのが好きなんだ。そうすれば、たいてい良い結果が出るから",
    },
    {
      name: "ビル\nゲイツ",
      value: "毎日毎日「勝ちたい」という気持ちで出社しなければならない。切羽詰まったときにこそ、最高の能力を発揮できる",
    },
    {
      name: "ビル\nゲイツ",
      value: "一心不乱に働くこと、ベストを尽くすことが嫌だというなら、ここは君のいるべき職場ではない",
    },
    {
      name: "ビル\nゲイツ",
    ...
    {
      name: "ビル\nゲイツ",
      value: "反対があるのは健全なこと。本当に力のあるアイデアか試されるわけだから",
    },
    {
      name: "ビル\nゲイツ",
      value: "私は起業家という言葉をいつも拒否してきた。「会社を始めよう、何の会社にしようか」では決して成功しない",
    },
    {
      name: "ビル\nゲイツ",
      value: "私は物事を自分のことを、この世の誰とも比べてはいけない。それは自分自身を侮辱する行為だとことん突き詰めるのが好きなんだ。そうすれば、たいてい良い結果が出るから",
    },
    {
      name: "ビル\nゲイツ",
    ...
    {
      name: "ビル\nゲイツ",
      value: "変わることがなければ成長することもない。成長することがなければ真に生きていない",
    },
  ];
